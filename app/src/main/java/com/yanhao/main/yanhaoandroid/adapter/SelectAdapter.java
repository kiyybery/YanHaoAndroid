...
public class SelectAdapter extends BaseAdapter {
    ...
    public SelectAdapter(Context pContext, List<SelectBean> pList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = _LayoutInflater.inflate(R.layout.fragment_select_item, null);
        RelayoutViewTool.relayoutViewWithScale(convertView, YanHao.screenWidthScale);
        if (convertView != null) {

            TextView _TextView1 = (TextView) convertView.findViewById(R.id.item_tv_select);
