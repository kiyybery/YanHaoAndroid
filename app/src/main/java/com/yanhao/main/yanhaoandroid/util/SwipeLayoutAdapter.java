...
public abstract class SwipeLayoutAdapter<T> extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            RelayoutViewTool.relayoutViewWithScale(contentView, YanHao.screenWidthScale);
            //获取操作区的View
            View actionView = LayoutInflater.from(getContext()).inflate(_actionViewResourceId, parent, false);
            RelayoutViewTool.relayoutViewWithScale(actionView, YanHao.screenWidthScale);
