...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    private List<CounselorInfo> counselorInfos;
    ...
    public void setData(List<ImageView> views, List list, ImageCycleListener listener) {
        setData(views, list, listener, 0);
    }
    ...
    public void setData(List<ImageView> views, List<CounselorInfo> list, ImageCycleListener listener, int showPosition) {
        imageCycleListener = listener;
        counselorInfos = list;
        this.imageViews.clear();
    ...
    private class ViewPagerAdapter extends PagerAdapter {
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            ...
            if (imageCycleListener != null) {
                v.setOnClickListener(new OnClickListener() {

                    @Override
                    public void onClick(View v) {
                        imageCycleListener.onImageClickL(counselorInfos.get(currentPosition), currentPosition, v);
                    }
                });
            }
            container.addView(v);
    ...
    public static interface ImageCycleListener {
